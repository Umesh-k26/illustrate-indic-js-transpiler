...
case 5: case 64: case 78: case 79: case 82: case 86: case 90: case 93: case 96: case 100: case 104: case 111: case 117: case 124: case 129: case 134: case 139: case 141: case 143: case 145: case 147: case 149: case 151: case 153: case 155: case 157: case 159: case 161: case 163: case 165: case 167: case 169: case 171: case 173: case 175: case 177: case 179: case 193: case 195: case 197: case 233: case 234:
 this.$ = $$[$0] 
break;
case 22: case 217: case 218: case 262:
 this.$ = $$[$0-1]; 
break;
case 34: case 38:
 this.$ = expNode($$[$0-3], $$[$0-1], 'array_access', '['); 
break;
case 35: case 39:
 this.$ = expNode($$[$0-2], $$[$0], 'object_access', '.'); 
break;
case 45: case 46: case 49: case 50:
 this.$ = expNode($$[$0-1], $$[$0], 'call_exp', null); 
break;
case 47: case 51:
 this.$ = expNode( $$[$0-3], $$[$0-1], 'call_exp', '['); 
break;
case 48: case 52:
 this.$ = expNode($$[$0-2], $$[$0], 'call_exp', '.'); 
break;
case 53:
 this.$ = ['arguments', []]; 
break;
...
case 55: case 296:
 this.$ = [$$[$0]]; 
break;
case 56: case 194: case 196: case 198: case 291:
 this.$ = $$[$0-2]; this.$.push($$[$0]); 
break;
case 62: case 65:
 this.$ = expNode($$[$0-1], null, 'post_fix_exp', '++'); 
break;
case 63: case 66:
 this.$ = expNode($$[$0-1], null, 'post_fix_exp', '--'); 
break;
...
break;
case 228: case 236: case 252: case 256:
 this.$ = $$[$0-1] 
break;
case 229:
 this.$ = 'yeah bro' 
...
break;
case 238:
 this.$ = ifelseNode($$[$0-2], $$[$0], null); 
break;
case 239:
 this.$ = ifelseNode($$[$0-4], $$[$0-2], $$[$0]); 
break;
case 240:
...
break;
case 286:
 this.$ = funcNode(null, $$[$0-1], null) 
break;
case 287:
 this.$ = funcNode(null, $$[$0-1], $$[$0-4]) 
break;
case 295:
 return $$[$0-1]; 
break;
...
rules: [/^(?:\/\/.*)/,/^(?:\/\*.*)/,/^(?:\s+)/,/^(?:शून्य)/,/^(?:सत्य)/,/^(?:असत्य)/,/^(?:यह)/,/^(?:रिक्त)/,/^(?:मिटाना)/,/^(?:प्रकार)/,/^(?:नया)/,/^(?:मान)/,/^(?:होने)/,/^(?:लगातार)/,/^(?:करना)/,/^(?:चक्रम्)/,/^(?:पर्यन्तम्)/,/^(?:साथ)/,/^(?:यदि)/,/^(?:अथ)/,/^(?:निर्देश)/,/^(?:यद)/,/^(?:यदभावे)/,/^(?:फेंकना)/,/^(?:प्रयत्न)/,/^(?:पकड़)/,/^(?:आखिरकार)/,/^(?:जारी_रखें)/,/^(?:विराम्)/,/^(?:फल)/,/^(?:सूत्र)/,/^(?:डिबगर)/,/^(?:([\u0900-\u097Fa-zA-Z][\u0900-\u097Fa-zA-Z0-9]*))/,/^(?:[0-9][0-9]*)/,/^(?:[0-9]+\.[0-9]*(([Ee][-+]?[0-9]+)\s*)?)/,/^(?:\.[0-9]+(([Ee][-+]?[0-9]+)\s*)?)/,/^(?:>>=)/,/^(?:<<=)/,/^(?:\+=)/,/^(?:-=)/,/^(?:\*=)/,/^(?:\/=)/,/^(?:%=)/,/^(?:&=)/,/^(?:\^=)/,/^(?:\|=)/,/^(?:>>)/,/^(?:<<)/,/^(?:>>>)/,/^(?:\+\+)/,/^(?:--)/,/^(?:&&)/,/^(?:\|\|)/,/^(?:<=)/,/^(?:>=)/,/^(?:==)/,/^(?:===)/,/^(?:!==)/,/^(?::)/,/^(?:;)/,/^(?:\{)/,/^(?:\})/,/^(?:=)/,/^(?:\()/,/^(?:\))/,/^(?:\[)/,/^(?:\])/,/^(?:\.)/,/^(?:,)/,/^(?:&)/,/^(?:!)/,/^(?:~)/,/^(?:-)/,/^(?:\+)/,/^(?:\*)/,/^(?:\/)/,/^(?:%)/,/^(?:<)/,/^(?:>)/,/^(?:\^)/,/^(?:\|)/,/^(?:\?)/,/^(?:$)/],
