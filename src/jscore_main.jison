...
// UnaryExprCommon
//     : DELETETOKEN UnaryExpr { $$ = unaryNode('delete', $2) }
//     | VOIDTOKEN UnaryExpr { $$ = unaryNode('void', $2) }
//     | TYPEOF UnaryExpr { $$ = unaryNode('typeof', $2) }
//     | PLUSPLUS UnaryExpr { $$ = unaryNode('++', $2) }
//     | AUTOPLUSPLUS UnaryExpr { $$ = unaryNode('++', $2) }
//     | MINUSMINUS UnaryExpr { $$ = unaryNode('--', $2) }
//     | AUTOMINUSMINUS UnaryExpr { $$ = unaryNode('--', $2) }
//     | '+' UnaryExpr { $$ = unaryNode('+', $2) }
//     | '-' UnaryExpr { $$ = unaryNode('-', $2) }
//     | '~' UnaryExpr { $$ = unaryNode('~', $2) }
//     | '!' UnaryExpr { $$ = unaryNode('!', $2) }
//     ;
...
RelationalExpr
    : ShiftExpr
    | RelationalExpr LESSTHEN ShiftExpr
...
RelationalExprNoIn
    : ShiftExpr
    | RelationalExprNoIn LESSTHEN ShiftExpr
...
RelationalExprNoBF
    : ShiftExprNoBF
    | RelationalExprNoBF LESSTHEN ShiftExpr
